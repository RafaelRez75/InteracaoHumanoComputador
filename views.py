...
########################### CURSOS
                    ...
                    bot.sendMessage(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            inline_keyboard=[
                                [InlineKeyboardButton(text="Turma A", callback_data='TurmaA')],
                                [InlineKeyboardButton(text="Turma B", callback_data='TurmaB')]
                            ]
                        )
                    )
                    txt.close()
                    ...
                    bot.sendMessage(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            inline_keyboard=[
                                [InlineKeyboardButton(text="Segunda", callback_data='SegAds3A')],
                                [InlineKeyboardButton(text="Terça", callback_data='TerAds3A')],
                                [InlineKeyboardButton(text="Quarta", callback_data='QuaAds3A')],
                                [InlineKeyboardButton(text="Quinta", callback_data='QuiAds3A')],
                                [InlineKeyboardButton(text="Sexta", callback_data='SexAds3A')],
                            ]
                        )
                    )
                    txt.close()
                    ...
                    bot.sendMessage(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            inline_keyboard=[
                                [InlineKeyboardButton(text="Segunda", callback_data='SegAds3B')],
                                [InlineKeyboardButton(text="Terça", callback_data='TerAds3B')],
                                [InlineKeyboardButton(text="Quarta", callback_data='QuaAds3B')],
                                [InlineKeyboardButton(text="Quinta", callback_data='QuiAds3B')],
                                [InlineKeyboardButton(text="Sexta", callback_data='SexAds3B')],
                            ]
                        )
                    )
                    txt.close()
                    ...
                    txt = open('/3Semestre/Turma A/SFA.md','r')
                    txt.read(),
                    txt.close()
                    
            elif(msg == 'TerAds3A'):
                   txt = open('/3Semestre/Turma A/TFA.md','r')
                    txt.read(),
                    txt.close()
                    
            elif(msg == 'QuaAds3A'):
                txt = open('/3Semestre/Turma A/QFA.md','r')
                    txt.read(),
                    txt.close()
                    
            elif(msg == 'QuiAds3A'):
                 txt = open('/3Semestre/Turma A/QFIA.md','r')
                    txt.read(),
                    txt.close()
                    
            elif(msg == 'SexAds3A'):
            txt = open('/3Semestre/Turma A/SXFA.md','r')
                    txt.read(),
                    txt.close()
                                        

            elif(msg == 'SegAds3B'):
                    txt = open('/3Semestre/Turma B/SFA.md','r')
                    txt.read(),
                    txt.close()
                    
            elif(msg == 'TerAds3B'):
                   txt = open('/3Semestre/Turma B/TFA.md','r')
                    txt.read(),
                    txt.close()
                    
            elif(msg == 'QuaAds3B'):
                txt = open('/3Semestre/Turma B/QFA.md','r')
                    txt.read(),
                    txt.close()
                    
            elif(msg == 'QuiAds3B'):
                 txt = open('/3Semestre/Turma B/QFIA.md','r')
                    txt.read(),
                    txt.close()
                    
            elif(msg == 'SexAds3B'):
            txt = open('/3Semestre/Turma B/SXFA.md','r')
                    txt.read(),
                    txt.close()                 
